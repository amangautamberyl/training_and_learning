...
class BuyersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buyer" do
    assert_difference('Buyer.count') do
      post buyers_url, params: { buyer: { address: @buyer.address, contact_num: @buyer.contact_num, name: @buyer.name } }
    end
  ...
  test "should update buyer" do
    patch buyer_url(@buyer), params: { buyer: { address: @buyer.address, contact_num: @buyer.contact_num, name: @buyer.name } }
