...
class ImageAttachmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create image_attachment" do
    assert_difference('ImageAttachment.count') do
      post image_attachments_url, params: { image_attachment: { avatar: @image_attachment.avatar, post_id: @image_attachment.post_id } }
    end
  ...
  test "should update image_attachment" do
    patch image_attachment_url(@image_attachment), params: { image_attachment: { avatar: @image_attachment.avatar, post_id: @image_attachment.post_id } }
