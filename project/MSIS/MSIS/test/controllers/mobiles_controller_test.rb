...
class MobilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mobile" do
    assert_difference('Mobile.count') do
      post mobiles_url, params: { mobile: { Imei_code: @mobile.Imei_code, Inventory: @mobile.Inventory, Name: @mobile.Name, Price: @mobile.Price, brand_id: @mobile.brand_id, manufacturing_date: @mobile.manufacturing_date } }
    end
  ...
  test "should update mobile" do
    patch mobile_url(@mobile), params: { mobile: { Imei_code: @mobile.Imei_code, Inventory: @mobile.Inventory, Name: @mobile.Name, Price: @mobile.Price, brand_id: @mobile.brand_id, manufacturing_date: @mobile.manufacturing_date } }
